 ...
 <p id="p-clay-26" class="reading-paragraph">وَشَعَرَ الْكُوبُ بِالْفَخْرِ وَالِاعْتِزَازِ وَقَالَ فِي نَفْسِهِ، أَخِيرًا - أَخِيرًا لَقَدْ صِرْتُ شَيْئًا.</p>`;
        ...
        const questions = {
            "لغة عربية": {
                ...
                "قطعة الصلصال الصغيرة": [
                    { q: "أين كانت قطعة الصلصال الصغيرة في بداية القصة؟ (ارجع إلى الفقرة 1)", options: ["على العجلة الدوارة", "في ركن قصي من الصندوق", "بجانب النافذة", "في التنور"], correct: 1, type: "multiple_choice", level: "استرجاع" },
                    { q: "ماذا شعرت قطعة الصلصال وهي داخل الصندوق؟ (ارجع إلى الفقرة 2)", options: ["بالفرح والسعادة", "بالخوف والرعب", "فقدت الأمل", "بالإثارة"], correct: 2, type: "multiple_choice", level: "تفسير" },
                    { q: "من الذي أخرج قطعة الصلصال من الصندوق؟ (ارجع إلى الفقرة 3)", options: ["صانع الفخار", "ولد من الأطفال", "المرأة التي جاءت لاحقًا", "البنت الصغيرة"], correct: 1, type: "multiple_choice", level: "استرجاع" },
                    { q: "ماذا فعل الولد بقطعة الصلصال على العجلة الدوارة؟ (ارجع إلى الفقرة 5)", options: ["صنع منها كوبًا", "كورها وجعلها كرة ملساء", "تركها كما هي", "رمى بها في النافذة"], correct: 1, type: "multiple_choice", level: "استرجاع" },
                    { q: "لماذا ترك الولد قطعة الصلصال بالقرب من النافذة؟ (ارجع إلى الفقرة 6)", options: ["لأنه انتهى من العمل بها", "لأن المعلم طلب منه التنظيف", "لأنه لم يعجبه شكلها", "لأنه أراد تجفيفها"], correct: 1, type: "multiple_choice", level: "استنتاج" },
                    { q: "كيف كانت حالة قطعة الصلصال بعد أن تركت بجانب النافذة؟ (ارجع إلى الفقرة 10)", options: ["ظلت رطبة ولينة", "صارت صلبة كصخرة", "جفت قليلاً", "تغير لونها"], correct: 1, type: "multiple_choice", level: "استرجاع" },
                    { q: "ما الذي أنقذ قطعة الصلصال من الجفاف التام؟ (ارجع إلى الفقرة 15)", options: ["الندى الصباحي", "مطر سقط من السماء", "رطوبة الجو", "أحد الأطفال سكب عليها ماء"], correct: 1, type: "multiple_choice", level: "استرجاع" },
                    { q: "من الذي وجد قطعة الصلصال بعد المطر؟ (ارجع إلى الفقرة 16)", options: ["صانع الفخار", "ولد من الأطفال", "امرأة وابنتها", "المعلم"], correct: 2, type: "multiple_choice", level: "استرجاع" },
                    ...
                    { q: "أين يعيش الكوب الآن؟ (ارجع إلى الفقرة 23)", options: ["في الورشة", "في المتحف", "على رف المطبخ", "عند البنت"], correct: 2, type: "multiple_choice", level: "استرجاع" },
                    ...
                    { q: "ما الذي حدث للقطعة بعد المطر؟ (ارجع إلى الفقرة 15)", options: ["ذابت", "جفت", "أصبحت لينة", "تكسرت"], correct: 2, type: "multiple_choice", level: "استنتاج" },
                    ...
                    { q: "ما الذي فعله الولد بالقطعة بعد التشكيل؟ (ارجع إلى الفقرة 7)", options: ["تركها بجانب النافذة", "أخذها للمنزل", "أعطاها للمعلمة", "رمى بها في النهر"], correct: 0, type: "multiple_choice", level: "استرجاع" },
                    ...
                    { q: "ما الذي جعل القطعة تشعر بالفخر في النهاية؟ (ارجع إلى الفقرة 26)", options: ["أنها أصبحت كوبًا مفيدًا", "أنها بقيت في الصندوق", "أنها لم تجف", "أنها تكسرت"], correct: 0, type: "multiple_choice", level: "تفسير" },
        ...
        function displayQuestion() {
            ...
            if (paragraphMatch) {
                ...
                const storyId = currentTest.level === 'ليلة لا تصدق' ? 'night' : 'clay';
