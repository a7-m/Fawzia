        ...
        const questions = {
            "لغة عربية": {
                ...
                "قطعة الصلصال الصغيرة": [
                    ...
                    { q: "ماذا شعرت قطعة الصلصال وهي داخل الصندوق؟", options: ["بالفرح والسعادة", "بالخوف والرعب", "فقدت الأمل", "بالإثارة"], correct: 2, type: "multiple_choice", level: "تفسير" },
                    { q: "من الذي أخرج قطعة الصلصال من الصندوق؟", options: ["صانع الفخار", "ولد من الأطفال", "المرأة التي جاءت لاحقًا", "البنت الصغيرة"], correct: 1, type: "multiple_choice", level: "استرجاع" },
                    ...
                    { q: "كيف شعر الكوب في النهاية؟", options: ["بالحزن", "بالفخر والاعتزاز", "بالخوف", "باللامبالاة"], correct: 1, type: "multiple_choice", level: "تفسير" },
