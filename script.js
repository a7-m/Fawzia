...
فِي الصَّبَاحِ كَانَ مِنَ الصَّعْبِ عَلَيْهَا أَنْ تَشْرَحَ لِوَالِدَيْهَا سَبَبَ بُقْعَةِ البَلَلِ الكَبِيرَةِ عَلَى الأَرْضِ وَالبَابِ المَكْسُورِ؛ لَمْ يَكُونَا مُقْتَنِعَيْنِ بِقِصَّةِ التِّمْسَاحِ مَعَ أَنَّ قُبَّعَةَ وَالِدَتِهَا مَا زَالَتْ مَفْقُودَةً.`;
        ...
        const readingPassage2 = `قطعة الصلصال الصغيرة
        
         في أعلى الطريق، وفي داخل قلعة قديمة، كانت هنالك ورشة مختصة في صناعة الفخاريات، وكانت الورشة مكتظة ببراميل من الطلاء الملون، وعجلات دوارة يستخدمها صانعو الفخاريات، وتنور لحرق المصنوعات الفخارية، وبالطبع الصلصال وبالقرب مني النافذة كان هنالك صندوق له غطاء ثقيل الوزن وكان الطين يتم حفظه في ذلك الصندوق. وفي ركن قصي من الصندوق كانت محشورة هنالك أقدم قطعة من الصلصال، وبالكاد تتذكر هذه القطعة أن آخر مرة استخدم فيها جزء منها كانت قبل وقت طويل، ويفتح غطاء الصندوق الثقيل في كل يوم، وتمتد أيادي لتمسك بسرعة بأكياس أو كرات الصلصال، وكان بإمكان قطعة الصلصال الصغيرة أن تسمع الأصوات المرحة للناس وهم منهمكون في أعمالهم داخل الورشة.
     تساءلت قطعة الصلصال الصغيرة، متى سيحين دوري؟ وكلما مر يوم بقطعة الصلصال الصغيرة داخل ظلام الصندوق كانت تفقد الأمل.
       وفي يوم من الأيام، حضرت مجموعة كبيرة من الأطفال إلى الورشة مع معلمهم، وامتدت أيادي كثيرة إلى داخل الصندوق، وكانت قطعة الصلصال الصغيرة هي آخر ما يتم اختياره، إلا أنها على أية حال قد خرجت من الصندوق.
وقالت قطعة الصلصال لنفسها وهي تحدق بعينين نصف مغمضتين، الآن جاءتني فرصتي الكبرى ...
      وقام ولد بوضع قطعة الصلصال على العجلة الدوارة وبدأ في تدويرها بأقصى سرعة استطاعها، وقالت قطعة الصلصال لنفسها، إن هذا الممتع، وحاول الولد جذب الصلصال إلى أعلى أثناء دوران العجلة، وشعرت قطعة الصلصال الصغيرة بالإثارة من حقيقة أنها ستصير شيئًا ما وبعد أن حاول الولد تشكيل وعاء فخاري صرف النظر عن ذلك، وقام بتكوير قطعة الصلصال وجعل منها كرة ملساء.
       وقال المعلم للأطفال، حان وقت تنظيف وترتيب المكان، وامتلأت الورشة بأصوات الأطفال وهم يقومون بالمسح والتنظيف والغسل والتنشيف وانتثر الماء في كل مكان.
         ورمى الولد قطعة الصلصال الصغيرة بالقرب من النافذة وأسرع للانضمام وسرع للانضمام إلى أصدقائه. وخلت الورشة من الجميع بعد فترة قصيرة، وساد الهدوء والظلام في أرجاء الورشة، وشعرت قطعة الصلصال بالرعب، ولم تفتقد رطوبة الصندوق فقط وإنما تملكها إحساس بالخطر.
وفكرت قطعة الصلصال الصغيرة وقالت لنفسها، انتهى الأمر.
سأظل جالسة هنا حتى أنشف وأصير يابسة وصلية كصخرة.
وظلت قطعة الصلصال قابعة بجوار النافذة المفتوحة، غير قادرة على الحركة، وتشعر بأن الرطوبة تنساب خارجة منها، وسقطت عليها أشعة الشمس ثم هبت عليها نسائم الليل حتى صارت صلبة كأنها صخرة حتى كادت أن تفقد القدرة على التفكير، كانت فقط تعلم أنها مشبعة بخيبة الأمل.
بيد أنه كانت لا تزال هنالك في أعماق قطعة الصلصال الصغيرة قطرة صغيرة من الرطوبة رفضت أن تسمح لها بالانسياب خارجا.
فكرت وقالت لنفسها، مطر
وتنهدت مهمهمة، ماء.
ثم عصرت نفسها لتخرج من ذاتها المحبطة اليائسة قائلة، أرجوك..
   وأحست سحابة عابرة بالرحمة والشفقة تجاه قطعة الصلصال الصغيرة، وحدث شيء رائع، تساقطت لطرقات المطرقة قطرات ضخمة عبر النافذة المفتوحة على قطعة الصلصال الصغيرة، وتواصل هطول المطر طوال الليل، وعند الصباح، كانت قطعة الصلصال الصغيرة لينة وطرية كما كانت في الماضي.
    وقالت امرأة اعتادت أن تستخدم الورشة في صناعة الفخاريات من حين لآخر عندما جاءت إلى الورشة بعد توقف هطول المطر، أوه لا، لقد ترك أحدهم النافذة مفتوحة طوال عطلة نهاية الأسبوع علينا تنظيف هذه الفوضى التي تعم المكان ثم قالت لابنتها التي كانت ترافقها، يمكنك أن تعملي ببعض الصلصال أثناء ما أعثر على المناشف
    ورأت البنت الصغيرة قطعة الصلصال قابعة بالقرب من النافذة وقالت، تبدو هذه القطعة مناسبة جدا لي.
وسرعان ما كانت تضغط وتعجن قطعة الصلصال الصغيرة وتصنع منها أشكالًا جميلة، وكانت أصابع البنت تولد في قطعة الصلصال إحساسًا رائعًا.
    واستغرقت البنت في التفكير وتحركت أصابعها لتصنع شيئاً محدداً من قطعة الصلصال الصغيرة وشعرت القطعة بأنها يتم تشكيلها بلطف ورقة في شكل دائري مجوف له مقبض.
وصاحت البنت، أمي، أمي، لقد صنعت كوبًا...
   وقالت الأم رائع ضعيه على الرف وسيتم إحراقه في التنور، ومن ثم يمكنك تلوينه بأي لون تشائين.
وسرعان ما صار الكوب الصغير جاهزًا ليؤخذ إلى منزله الجديد.
     ويعيش في الوقت الحاضر على رف المطبخ بجانب الأكواب والأقداح والكؤوس الأخرى، إنها جميعها مختلفة. وبعضها جميل جدا..
        ونادت الأم على ابنتها وهي تضع الكوب الجديد على المائدة وهي تملأه بشراب الشوكولاتة الساخن الإفطار.
      وظلت البنت ممسكة بالكوب الجديد برقة ولطف. كم يشعر الكوب بالسعادة من خطوط شكله الجديد! ما أروع أدائه لوظيفته!
وشعر الكوب بالفخر والاعتزاز وقال في نفسه، أخيرا - أخيراً لقد صرت شيئًا.`;
        ...
        const questions = {
            "لغة عربية": {
                ...
                "قطعة الصلصال الصغيرة": [
                    ...
                    { q: "ما الدرس الرئيس من القصة؟", options: ["الصبر والتحول", "عدم التخلي عن الأحلام", "أهمية الماء", "قيمة الأشياء الصغيرة"], correct: 0, type: "multiple_choice", level: "تقويم" },
                    { q: "لماذا كانت قطعة الصلصال تشعر باليأس؟ اكتب سببًا", type: "essay", modelAnswer: "(يقبل من الطالب ما يفيد المعنى) شعرت باليأس لأنها كانت عالقة في الصندوق لفترة طويلة دون أن تستخدم، ثم عندما خرجت تركت لتنشف وتصبح صلبة كالصخرة، فاعتقدت أن فرصتها قد ضاعت", level: "تفسير" },
        ...
        if (levelSelect) {
            // لا تحدد مستوى افتراضي الآن، دع المستخدم يختار
        ...
        function displayQuestion() {
            ...
            // إضافة النص للقراءة في المستويات التي تحتاج إلى نص
            if ((currentTest.level === 'ليلة لا تصدق' || currentTest.level === 'قطعة الصلصال الصغيرة') && currentTest.currentQuestion === 0) {
                ...
                // اختيار النص المناسب بناءً على المستوى
            ...
            // إضافة زر عرض النص للمستويات التي تحتاج إلى نص
            const existingShowTextBtn = document.getElementById('showTextBtn');
            if (currentTest.level === 'ليلة لا تصدق' || currentTest.level === 'قطعة الصلصال الصغيرة') {
